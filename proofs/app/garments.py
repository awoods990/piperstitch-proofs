...
TEMPLATES: list[Template] = [
    ...
    Template("unstructured_cap", "Unstructured (dad) cap", "cap", 300, [(190, 500), (250, 340), (350, 240), (500, 205), (650, 240), (750, 340), (810, 500), (960, 540), (890, 600), (600, 575), (400, 575), (110, 600), (30, 540)],
             seams=[[(500, 205), (500, 500)], [(350, 240), (405, 500)], [(650, 240), (595, 500)], [(190, 500), (810, 500)]],
             zones=[Zone("front", "Front panel", 500, 400, 280, 150, "bottom of the front panel", 500, 500, curve=0.3), Zone("side", "Left side", 290, 420, 110, 80, "front panel seam", 350, 420, curve=0.2)], default_zone="front"),
    Template("trucker_cap", "Trucker cap (mesh back)", "cap", 300, [(180, 480), (230, 290), (330, 180), (500, 140), (670, 180), (770, 290), (820, 480), (960, 520), (900, 580), (600, 560), (400, 560), (100, 580), (40, 520)],
             seams=[[(500, 140), (500, 480)], [(330, 180), (400, 480)], [(670, 180), (600, 480)], [(180, 480), (820, 480)]]
                   + [[(230 + i * 12, 300 + i * 9), (260 + i * 12, 470)] for i in range(0, 8)] + [[(770 - i * 12, 300 + i * 9), (740 - i * 12, 470)] for i in range(0, 8)],
             zones=[Zone("front", "Front (foam) panel", 500, 360, 300, 180, "bottom of the front panel", 500, 480, curve=0.25)], default_zone="front"),
    Template("flat_bill", "Flat-bill snapback", "cap", 300, [(180, 480), (220, 280), (330, 170), (500, 130), (670, 170), (780, 280), (820, 480), (990, 480), (990, 540), (600, 560), (400, 560), (10, 540), (10, 480)],
             seams=[[(500, 130), (500, 480)], [(330, 170), (400, 480)], [(670, 170), (600, 480)], [(180, 480), (820, 480)]],
             zones=[Zone("front", "Front panel", 500, 350, 320, 190, "bottom of the front panel", 500, 480, curve=0.3), Zone("side", "Left side", 270, 400, 120, 90, "front panel seam", 330, 400, curve=0.2)], default_zone="front"),
    Template("visor", "Visor", "cap", 300, [(200, 400), (800, 400), (800, 480), (960, 520), (900, 580), (600, 560), (400, 560), (100, 580), (40, 520), (200, 480)],
             seams=[[(200, 480), (800, 480)]], zones=[Zone("front", "Front band", 500, 440, 280, 60, "bottom of the band", 500, 480, curve=0.2)], default_zone="front"),
    ...
    Template("beanie_slouch", "Beanie, no cuff", "cap", 260, [(200, 600), (200, 300), (270, 150), (420, 70), (580, 70), (740, 150), (800, 300), (800, 600), (500, 650)],
             seams=[[(500, 70), (500, 650)], [(330, 125), (360, 630)], [(670, 125), (640, 630)]], zones=[Zone("front", "Front, above the edge", 500, 480, 220, 110, "bottom edge", 500, 635, curve=0.25)], default_zone="front"),
